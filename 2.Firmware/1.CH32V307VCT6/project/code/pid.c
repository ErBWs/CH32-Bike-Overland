...
#define SERVO_MAX_ANGLE 16.0
    ...
    PID_Init(&flySpdPid,POSITION_PID,PWM_DUTY_MAX-10,0,0.23,0,0);//飞轮速度环纯P
    PID_Init(&flyAnglePid,POSITION_PID,PWM_DUTY_MAX-10,0,12.0,0,0);//飞轮角度环PD
    PID_Init(&flyAngleSpdPid,POSITION_PID,PWM_DUTY_MAX-10,PWM_DUTY_MAX-10,-34,-0.7,0);//飞轮角速度环PI
