...
#define SERVO_MAX_ANGLE 10.0
    ...
    PID_Init(&flySpdPid,POSITION_PID,PWM_DUTY_MAX-10,0,3,0,0);//飞轮速度环纯P
    PID_Init(&flyAnglePid,POSITION_PID,PWM_DUTY_MAX-10,0,25,0,0);//飞轮角度环PD
    PID_Init(&flyAngleSpdPid,POSITION_PID,PWM_DUTY_MAX-10,PWM_DUTY_MAX-10,-100,-0.6f,0);//飞轮角速度环PI
    PID_Init(&backSpdPid,POSITION_PID,PWM_DUTY_MAX-10,6000,50,1.2f,-0.2f);//
...
//    PID_Init(&flyAngleSpdPid,POSITION_PID,PWM_DUTY_MAX-10,PWM_DUTY_MAX-10,-34.5,-0.7f,0);//飞轮角速度环PI
//    PID_Init(&backSpdPid,POSITION_PID,PWM_DUTY_MAX-10,6000,150,1.2f,-0.2f);//后轮速度环纯P
