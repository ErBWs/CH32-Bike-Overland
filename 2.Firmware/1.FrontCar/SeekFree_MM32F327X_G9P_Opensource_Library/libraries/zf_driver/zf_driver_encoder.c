...
// @return      void
// Sample usage:                encoder_quad_init(TIM3_ENCOEDER, TIM3_ENCOEDER_CH1_B4, TIM3_ENCOEDER_CH2_B5);
//-------------------------------------------------------------------------------------------------------------------
...
// @param       ch2_pin         ENCODER 通道 2 参照 zf_driver_encoder.h 内 encoder_channel_enum 枚举体定义
// @return      void
// Sample usage:                encoder_dir_init(TIM3_ENCOEDER, TIM3_ENCOEDER_CH1_B4, TIM3_ENCOEDER_CH2_B5);
