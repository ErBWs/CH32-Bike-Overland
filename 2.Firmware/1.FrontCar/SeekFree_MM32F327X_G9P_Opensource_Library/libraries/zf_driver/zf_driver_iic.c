...
//-------------------------------------------------------------------------------------------------------------------
// @brief       IIC 接口传输 8bit 数组 先写后读取
// @param       iic_n           IIC 模块号 参照 zf_driver_iic.h 内 iic_index_enum 枚举体定义
// @param       target_addr     目标器件地址
// @param       *write_data     发送数据存放缓冲区
// @param       write_len       发送缓冲区长度
// @param       *read_data      读取数据存放缓冲区
// @param       read_len        读取缓冲区长度
// @return      void            
// Sample usage:                iic_transfer_8bit_array(IIC_1, addr, data, 64, data, 64);
//-------------------------------------------------------------------------------------------------------------------
...
// @param       read_len        读取缓冲区长度
// @return      void            
// Sample usage:                iic_transfer_16bit_array(IIC_1, addr, data, 64, data, 64);
//-------------------------------------------------------------------------------------------------------------------
