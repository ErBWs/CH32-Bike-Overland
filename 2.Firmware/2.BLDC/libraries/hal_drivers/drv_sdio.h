...
typedef rt_uint32_t (*sdio_clk_get)(struct ch32_sdio *hw_sdio);

struct ch32_sdio_des
{
...
struct ch32_sdio_config
{
    SDCARD_INSTANCE_TYPE *Instance;
    struct dma_config dma_rx, dma_tx;
};

/* ch32 sdio dirver class */
struct ch32_sdio_class
{
    struct ch32_sdio_des *des;
    const struct ch32_sdio_config *cfg;
...
extern void ch32_mmcsd_change(void);
